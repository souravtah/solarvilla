                    ...
                    <div class="col-lg-10 col-md-9 col-xl-7 mx-auto">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" pattern="\d{10}" maxlength="10" class="form-control" id="phone"
                                    name="phone" placeholder="{{ __('Phone') }}" required autocomplete="phone">
                                @error('phone')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                                    </span>
