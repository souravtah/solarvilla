    ...
    <div class="container-fluid">
        <div class="border-bottom pt-6">
            ...
            <ul class="nav nav-tabs overflow-x border-0">
                @role('Client')
                <li class="nav-item"><a href="{{ route('users.get_help') }}" class="nav-link {{ (request()->is('users/help/get-help')) ? 'active font-bold' : '' }}"><i class="bi bi-question-diamond"></i> Get Help</a></li>
                <li class="nav-item"><a href="{{ route('home') }}" class="nav-link {{ (request()->is('home')) ? 'active font-bold' : '' }}"><i class="bi bi-clock-history"></i> Overview</a></li>
