                ...
                <div class="header-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="#!" class="btn btn-primary ms-2 lift">
                                Pay
                            </a>
            ...
            <div class="card card-body p-5">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <!-- Logo -->
                        <img src="{{ asset('assets/images/solarvilla/logo/solarvilla-logo-light.webp') }}" alt="..." class="img-fluid mb-4" style="max-width: 2.5rem;">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-0">
                            ...
                            know! Also, should you need us to add VAT or anything else to this order, it’s super easy
