...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/utilities.css"><!-- Google Tag Manager -->
    <script defer data-domain="webpixels.works" src="../../plausible.io/js/plausible.js"></script>
</head>
            ...
            <div class="container-fluid"><button class="navbar-toggler ms-n2" type="button" data-bs-toggle="collapse"
                ...
                <div class="navbar-user d-lg-none">
                    <div class="dropdown"><a href="#" id="sidebarAvatar" role="button" data-bs-toggle="dropdown"
                            ...
                            <div class="avatar-parent-child"><img alt="..." src="../../img/people/img-profile.jpg"
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link" href="#sidebar-projects" data-bs-toggle="collapse"
                            ...
                            <div class="collapse" id="sidebar-projects">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="../projects/overview.html"
                                    ...
                                    <li class="nav-item"><a href="../projects/create-project.html"
                        ...
                        <li class="nav-item"><a class="nav-link" href="#sidebar-files" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="sidebar-files"><i
                                    class="bi bi-file-earmark-text"></i> Files</a>
                            ...
                            <div class="collapse" id="sidebar-integrations">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item"><a href="../integrations/manage-apps.html"
                                            class="nav-link">Manage Apps</a></li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="collapse" id="sidebar-user">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item"><a href="../user/table-view.html" class="nav-link">Table
                                            View</a></li>
                                    <li class="nav-item"><a href="../user/permissions.html"
                                            class="nav-link">Permissions</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item"><a class="nav-link active" href="#sidebar-settings"
                                data-bs-toggle="collapse" role="button" aria-expanded="true"
                                aria-controls="sidebar-settings"><i class="bi bi-gear"></i> Settings</a>
                            <div class="collapse show" id="sidebar-settings">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="general.html" class="nav-link font-bold">General</a>
                                    </li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="#sidebar-authentication"
                            ...
                            <div class="collapse" id="sidebar-authentication">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="../authentication/basic-login.html"
                                            class="nav-link">Basic Login</a></li>
                                    <li class="nav-item"><a href="../authentication/basic-register.html"
                                            class="nav-link">Basic Register</a></li>
                                    <li class="nav-item"><a href="../authentication/basic-recover.html"
                                            class="nav-link">Basic Recover</a></li>
                                    <li class="nav-item"><a href="../authentication/side-login.html"
                                            class="nav-link">Side Login</a></li>
                                    <li class="nav-item"><a href="../authentication/side-register.html"
                                            class="nav-link">Side Register</a></li>
                                    <li class="nav-item"><a href="../authentication/side-recover.html"
                ...
                <div class="container-fluid max-w-screen-md vstack gap-6">
                                ...
                                <div>
                                    <div class="d-flex align-items-center"><a href="#"
                                            class="avatar avatar-lg bg-warning rounded-circle text-white"><img alt="..."
                                                src="../../img/people/img-profile.jpg"></a>
                                        <div class="ms-4"><span class="h4 d-block mb-0">Tahlia Mooney</span> <a href="#"
                    ...
                    <div>
                        ...
                        <form>
                            <div class="row g-5">
                                <div class="col-md-6">
                                    <div><label class="form-label">First name</label> <input type="text"
                                            class="form-control" id="first_name"></div>
                                </div>
                                <div class="col-md-6">
                                    <div><label class="form-label">Last name</label> <input type="text"
                                ...
                                <div class="col-md-6">
                                    <div><label class="form-label">Phone number</label> <input type="tel"
                                            class="form-control"></div>
                                </div>
                                <div class="col-12">
                                    <div><label class="form-label">Address</label> <input type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-2">
                                    <div><label class="form-label" for="zip">ZIP</label> <input type="tel"
                                            class="form-control" id="zip"></div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check"><input class="form-check-input" type="checkbox"
                                            name="check-primary-address" id="check-primary-address"> <label
                                            class="form-check-label" for="check-primary-address">Make this my default
                                            address</label></div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-sm text-muted mb-4">Permanently remove your account and all of its
                                        ...
                                        type="button" class="btn btn-sm btn-danger">Delete my account</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from clever-dashboard.webpixels.work/pages/settings/general.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Sep 2022 13:38:43 GMT -->
