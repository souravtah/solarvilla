            ...
            <div class="bg-light rounded-3 position-relative p-3 p-sm-4">
                ...
                <div class="row">
                    <div class="col-md-7 mx-auto text-center py-5">
                        <!-- Title -->
                        <h2 class="mb-4">Check your ticket status</h2>
                        <p class="mb-4">Enter your support ticket number below:</p>
                        <!-- Form -->
                        <form class="bg-body shadow rounded-2 p-2">
                            <div class="input-group">
                                <input class="form-control border-0 me-1" type="email" placeholder="Enter your support ticket number here..">
                                <button type="button" class="btn btn-dark rounded-2 mb-0">View Status</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="bg-primary bg-opacity-10 rounded-3 h-100 p-4">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="ms-3">
                                ...
                                <a href="tel:09876543210" class="btn btn-sm btn-dark mb-2"><i class="bi bi-phone me-2"></i>Click to call +91 9876543210</a>
                                <a href="tel:09876543210" class="btn btn-sm btn-primary"><i class="bi bi-telephone-outbound-fill me-2"></i></i>Click to call +91 9876543210</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 position-relative overflow-hidden">
                    <div class="bg-primary bg-opacity-10 rounded-3 h-100 p-4">
                        ...
                        <div class="d-flex">
                            <!-- Icon -->
                            <div class="icon-lg text-white bg-primary rounded-circle flex-shrink-0"><i class="fa-solid fa-ticket"></i></div>
                            <!-- Content -->
                            <div class="ms-3">
