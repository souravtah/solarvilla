                                                    ...
                                                    <div class="text-sm">
                                                        ...
                                                        @if (max($current_ticket_labels) == $ticket_label && $ticket_label != 5)
                                                            ...
                                                            <div class="d-inline-block mx-1">
                                                                <a href="{{ route('tickets.edit', ['ticket' => $ticket->id]) }}" class="badge rounded-pill bg-success bg-opacity-20 bg-opacity-100-hover text-success text-white-hover">Proceed to next step</a>
                                                            </div>
                                                            @endif
