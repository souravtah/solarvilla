                ...
                <div class="col-lg-10 mx-auto">
                    ...
                    <div class="bg-mode border rounded p-4">
                        ...
                        <div class="d-flex">
                            ...
                            <!-- Info -->
                            <div>
                                <h4 class="m-0"><a href="#">Riya Ray</a></h4>
                                <small>CEO at Solarvilla Multitrade Pvt. Ltd</small>
                            </div>
                        </div>

                        <!-- Content -->
                        <p class="my-3">Louis Ferguson has written about government, criminal justice, and the role of money in politics since 2015.Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly cordial in do. Water timed folly right aware if oh truth.</p>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link px-2 fs-5" href="#"><i class="fa-brands fa-linkedin-in"></i></a>
                                </li>
                            </ul>
                            <!-- Button -->
                    ...
                    {{-- <div class="bg-light rounded d-md-flex justify-content-between align-items-center text-center p-3 mt-4">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <label class="btn btn-outline-light btn-sm mb-0" for="btnradio1"><i class="fa-regular fa-thumbs-up me-1"></i> Yes</label>
                            <!-- No button -->
                            <input type="radio" class="btn-check" name="btnradio" id="btnradio2">
                            <label class="btn btn-outline-light btn-sm mb-0" for="btnradio2"> No <i class="fa-regular fa-thumbs-down ms-1"></i></label>
                        </div>
                    </div> --}}
                    <!-- Review poll END -->
                    ...
                    {{-- <div class="d-lg-flex justify-content-lg-between mt-4">
                        ...
                        <div class="align-items-center">
                            ...
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"> <a class="btn btn-light btn-sm mb-xl-0" href="#">blog</a> </li>
                                <li class="list-inline-item"> <a class="btn btn-light btn-sm mb-xl-0" href="#">Tour</a> </li>
                                <li class="list-inline-item"> <a class="btn btn-light btn-sm mb-xl-0" href="#">Holidays</a> </li>
                                <li class="list-inline-item"> <a class="btn btn-light btn-sm mb-xl-0" href="#">Ticket Booking</a> </li>
                                <li class="list-inline-item"> <a class="btn btn-light btn-sm mb-xl-0" href="#">deep learning</a> </li>
                            </ul>
                        </div>
                    </div> --}}
