            ...
            <div class="border-bottom pt-6">
                <div class="row align-items-center">
                    <div class="col-sm-12 col-12">
                        <h1 class="h2 ls-tight">Prepare Quotation</h1>
                    </div>
                </div>
                    ...
                    <section class="card-body col-md-8 pt-2 pt-lg-4 pb-4 mb-3">
                        <div class="pt-2 px-4 pe-lg-0 ps-xl-5">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center border-bottom pb-3">
                                <div class="py-1">
                                    <a class="btn btn-warning btn-sm" href="{{ route('quotations.index') }}">
                            ...
                            <form id="cartEvaluation" method="POST" action="{{ route('quotations.store') }}">
                                @csrf
                            <!-- Product-->
                    ...
                    <aside class="col-md-4 ps-xl-5">
                        ...
                        <div class="row p-4 h-100 ms-auto border-start">
                            ...
                            <div class="mt-4 row">
                                ...
                                <div class="col-md-12 mb-4 form-control-bg-light">
                                    <h6 class="text-sm font-semibold">Quotation date</h6>
                                    <div class="mt-3">
                            ...
                            <div class="col-12 text-center">
                                <button onclick="myFunctionFormEvaluateCartItems()" class="btn btn-primary btn-shadow w-100 mt-4">
                                    <i class="bi bi-shield-check"></i> Securely generate quotation <i class="bi bi-arrow-right-circle"></i>
                                </button>
